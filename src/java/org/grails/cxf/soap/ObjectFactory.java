...
public class ObjectFactory {
    ...
    private final static QName _NoSuchCustomer_QNAME = new QName("http://test.cxf.grails.org/", "NoSuchCustomer");
    private final static QName _GetCustomersByNameResponse_QNAME = new QName("http://test.cxf.grails.org/", "getCustomersByNameResponse");
    private final static QName _GetCustomersByName_QNAME = new QName("http://test.cxf.grails.org/", "getCustomersByName");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test.cxf.grails.org/", name = "NoSuchCustomer")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test.cxf.grails.org/", name = "getCustomersByNameResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test.cxf.grails.org/", name = "getCustomersByName")
